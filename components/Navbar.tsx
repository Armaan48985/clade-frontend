...
const Navbar = () => {
  return (
    <div className='w-full h-[109px] py-6 px-10 sticky top-0 left-0 z-10 bg-white shadow-sm shadow-gray-300'>
      <div className='flex-between h-[61px]'>
        <div className='bg-[var(--primary-gray)] w-[100px] h-full flex-center'>
          <p className='text-[var(--primary-red)] font-bold text-xl'>Login</p>
        </div>

        <div className='w-[538px] flex-between border-[0.5px] border-[var(--primary-border-gray)] rounded-[36px] text-xl h-[74px] px-3'>
