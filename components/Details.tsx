...
const Details = () => {
  return (
    <div className='flex flex-col font-medium'>
        {/* first section */}
        <div className='border-b-2 border-[var(--light-border-gray)] pl-[100px] py-9'>
          <div className=' '>
            <div className='flex items-center gap-2'>
              ...
              <div className='border-[1px] border-[var(--light-green)] rounded-full bg-[#ECFDF3] flex-center gap-2 px-2'>
            ...
            <div className='mt-6 flex items-center gap-5'>
              <div className='flex-center gap-2'>
                <Image src='/location.png' width={20} height={20} alt='company-logo' className='w-4 h-5'/>
              ...
              <div className='flex-center gap-2'>
                <Image src='/coins.png' width={20} height={20} alt='company-logo' className='w-5 h-[18px]'/>
        ...
        {/* second section */}
        <div className='border-b-2 border-[var(--light-border-gray)] py-7 pl-[100px]'>
          <div className='w-[872px]  flex items-start justify-between'>
              <div className='flex flex-col gap-2'>
                <h3 className='text-sm text-[var(--text-light-gray)]'>skills required</h3>
                <div className='w-max h-[24px] border-[1px] border-[var(--light-border-gray)] flex rounded-md gap-1 py-1 px-[6px]'>
            ...
            <div className='flex flex-col gap-2'>
                ...
                <p className='text-md text-[var(--text-black)] font-semibold'>English</p>
            </div>
            <div className='flex flex-col gap-2 mr-5'>
                <h3 className='text-sm text-[var(--text-light-gray)]'>Type</h3>
                <p className='text-md text-[var(--text-black)] font-semibold'>Full time</p>
            </div>
            <div className='flex flex-col gap-2'>
                <h3 className='text-sm text-[var(--text-light-gray)]'>Years of Experience</h3>
                <p className='text-md text-[var(--text-black)] font-semibold'>3+ Years of Experience</p>
            </div>
          </div>
        </div>

        {/* third section */}
        <div className='border-b-2 border-[var(--light-border-gray)] pl-[100px] py-8 font-medium'>
          <div className=''>
              <p className='text-sm text-[var(--text-light-gray)]'>About the job</p>
              <div className='mt-2 text-md text-[var(--text-black)] flex flex-col gap-1'>
